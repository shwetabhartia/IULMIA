...
<div id="main">
	<table>
        ...
        <div id="page">
          <?php
            global $connection;
            $retrieve_condition_query = 'SELECT BIB_BASIC.Bib_IU_Barcode, BIB_BASIC.Bib_Title, BIB_BASIC.Bib_Creator, BIB_COND.BibCond_Research_Value, BIB_COND.BibCond_Research_Value_Note from BIB_BASIC INNER JOIN BIB_COND ON BIB_BASIC.Bib_IU_Barcode = BIB_COND.Bib_IU_Barcode ORDER BY BIB_COND.BibCond_Research_Value ASC';
            $results_per_page = 10;
            ...
            $output = "<h2 style=\"color:#990000;\">VALUE</h2></br><ol start = '$offset'>";
  					while($movie = mysqli_fetch_array($pageresults)) {
  						...
  						$output .=  "<br>";
  						$output .= "Research Value:";
  						$output .= $movie["BibCond_Research_Value"];
  						$output .=  "<br>";
  						$output .=  "Research Value Note: ";
  						$output .= $movie["BibCond_Research_Value_Note"];
  						$output .= "<br></li>";
  					}
  					$output .= "</ol>";
  					echo $output;
            ...
            // display the links to the pages
  					for ($page=1;$page<=$number_of_pages;$page++) {
  						echo '<a href="value.php?page=' . $page . '">' . $page . '</a> ';
  					}
