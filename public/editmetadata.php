...
if (isset($_POST['edit'])) {
	...
	if (!$IU_Barcode) {
		// IU_Barcode was invalid or 
		// IU_Barcode couldn't be found in database
	...
	$query_bib_ident .= "WHERE Bib_IU_Barcode = '{$Bib_IU_Barcode}' ";
	...
	$query_bib_tech .= "WHERE Bib_IU_Barcode = '{$Bib_IU_Barcode}' ";
	...
	$query_bib_cond .= "WHERE Bib_IU_Barcode = '{$Bib_IU_Barcode}' ";
		...
		<tr>
			...
			<td width="80%">
				<div id="page">
					...
					<form action="editmetadata.php" method="post">
